// DEPRECATED: This file is deprecated and will be removed after migration to Express.js
// New services should use httpClient.ts instead
...
if (!supabaseUrl || !supabaseAnonKey) {
  console.warn('Missing Supabase environment variables - this is expected during migration to Express.js')
}
