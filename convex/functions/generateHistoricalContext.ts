...
const defaultTemplate = "Discuss the context and background of the text {bible_text}";
...
try {
  ...
  console.error("Failed to read context explorer prompt template, falling back to default", error);
}
