...
export default function OriginalLanguageStudyPage() {
  ...
  const handleGetExplanation = async () => {
    ...
    setTimeout(() => {
      ...
      Alert.alert(
        'Explanation Ready!',
        'Greek and Hebrew word study information is ready. This feature will be fully implemented soon.',
        [{ text: 'OK' }]
      );
    }, 2000);
  };
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.inputCard}>
          ...
          <Text style={styles.inputSubtext}>
            Enter the Bible verse you'd like an original language explanation provided for
          </Text>
          <TextInput
        ...
        <Card style={styles.generateCard}>
          <Button
            title={isGenerating ? 'Getting Explanation...' : 'Get Explanation'}
